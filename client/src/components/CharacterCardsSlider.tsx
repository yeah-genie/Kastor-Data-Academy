    ...
    <div className="my-4">
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <p className="text-sm font-semibold text-amber-900">Team profiles have been updated in your notebook!</p>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    {char.photo && (
                      <img
                        src={char.photo}
                        alt={char.name}
                        className="w-20 h-20 rounded-2xl object-cover object-center border-2 border-blue-400 shadow-md"
                      />
                    )}
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-gray-900 mb-1">{char.name}</h3>
                      <p className="text-sm text-blue-700 font-semibold">{char.role}</p>
                    </div>
                  </div>
                  
                  <div className="bg-white rounded-lg p-3 border border-blue-200 shadow-sm">
                    <p className="text-xs font-bold text-gray-800 mb-1">PROFILE</p>
