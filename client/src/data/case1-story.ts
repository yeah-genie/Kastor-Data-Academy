...
export const case1Story: Record<string, StoryNode> = {
  ...
  maya_interview: {
    ...
    question: {
      ...
      choices: [
        { id: "c7", text: "Talk to Chris", isCorrect: true, nextNode: "chris_interview", feedback: "", evidenceAwarded: case1Evidence.maya_dialogue, pointsAwarded: 10 },
        { id: "c8", text: "Talk to Ryan", isCorrect: true, nextNode: "ryan_interview", feedback: "", evidenceAwarded: case1Evidence.maya_dialogue, pointsAwarded: 10 },
      ],
    },
  },
  ...
  chris_interview: {
    ...
    question: {
      ...
      text: "🎯 Who else should we talk to?",
      choices: [
        { id: "c9", text: "Talk to Maya", isCorrect: true, nextNode: "maya_interview", feedback: "", evidenceAwarded: case1Evidence.chris_dialogue, pointsAwarded: 10 },
        { id: "c10", text: "Talk to Ryan", isCorrect: true, nextNode: "ryan_interview", feedback: "", evidenceAwarded: case1Evidence.chris_dialogue, pointsAwarded: 10 },
      ],
    },
  },
  ...
  ryan_interview: {
    ...
    question: {
      ...
      text: "🎯 Who else should we talk to?",
      choices: [
        { id: "c11", text: "Talk to Maya", isCorrect: true, nextNode: "maya_interview", feedback: "", evidenceAwarded: [case1Evidence.ryan_dialogue, case1Evidence.server_logs], pointsAwarded: 10 },
        { id: "c12", text: "Talk to Chris", isCorrect: true, nextNode: "chris_interview", feedback: "", evidenceAwarded: [case1Evidence.ryan_dialogue, case1Evidence.server_logs], pointsAwarded: 10 },
        { id: "c13", text: "Analyze the server logs", isCorrect: true, nextNode: "stage3_start", feedback: "", evidenceAwarded: [case1Evidence.ryan_dialogue, case1Evidence.server_logs], pointsAwarded: 15 },
      ],
    },
  },
